Thanks for the simulation platform of Convex Analysis of Mixture and Compartmental Modeling (CAM-CM) package. Our MVC-NMF experiments are all based on CAM-CM software package.
...
To start the simulation, find "\CAM software for AN_sim only\Simulation data\Simulator.m" and run it.
